\page BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterMelee BP_SpitterMelee
### Parent Class :
[FGProjectile](@ref ClassScriptFGProjectile)
### Asset Path :
<b><blockquote>/Game/FactoryGame/Character/Creature/Enemy/Spitter/BP_SpitterMelee.BP_SpitterMelee_C</blockquote></b>
## Components

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterMeleeSphere1

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterMeleeParticleSystem

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterMeleemCollisionComp

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterMeleemProjectileMovement

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterMeleeRootComponent
