\page BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileSplit BP_SpitterProjectileSplit
### Parent Class :
[FGProjectile](@ref ClassScriptFGProjectile)
### Asset Path :
<b><blockquote>/Game/FactoryGame/Character/Creature/Enemy/Spitter/BP_SpitterProjectileSplit.BP_SpitterProjectileSplit_C</blockquote></b>
## Components

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileSplitSphere

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileSplitProjectile

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileSplitmCollisionComp

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileSplitmProjectileMovement

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileSplitRootComponent
