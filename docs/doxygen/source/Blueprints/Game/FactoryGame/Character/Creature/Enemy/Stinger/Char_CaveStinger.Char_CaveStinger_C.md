\page BlueprintsGameFactoryGameCharacterCreatureEnemyStingerChar_CaveStinger Char_CaveStinger
### Parent Class :
[Char_Stinger](@ref BlueprintsGameFactoryGameCharacterCreatureEnemyStingerChar_Stinger)
### Asset Path :
<b><blockquote>/Game/FactoryGame/Character/Creature/Enemy/Stinger/Char_CaveStinger.Char_CaveStinger_C</blockquote></b>
## Components

@ref BlueprintsGameFactoryGameCharacterCreatureEnemyStingerChar_CaveStingermEyeLocationComponent

@ref BlueprintsGameFactoryGameCharacterCreatureEnemyStingerChar_CaveStingermHealthComponent

@ref BlueprintsGameFactoryGameCharacterCreatureEnemyStingerChar_CaveStingerMesh

@ref BlueprintsGameFactoryGameCharacterCreatureEnemyStingerChar_CaveStingerCharacterMovement

@ref BlueprintsGameFactoryGameCharacterCreatureEnemyStingerChar_CaveStingerCapsuleComponent

@ref BlueprintsGameFactoryGameCharacterCreatureEnemyStingerChar_CaveStingerRootComponent
