\page BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileBig BP_SpitterProjectileBig
### Parent Class :
[FGProjectile](@ref ClassScriptFGProjectile)
### Asset Path :
<b><blockquote>/Game/FactoryGame/Character/Creature/Enemy/Spitter/BP_SpitterProjectileBig.BP_SpitterProjectileBig_C</blockquote></b>
## Components

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileBigSphere

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileBigProjectile

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileBigmCollisionComp

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileBigmProjectileMovement

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileBigRootComponent
