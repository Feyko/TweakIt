\page BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectile BP_SpitterProjectile
### Parent Class :
[FGProjectile](@ref ClassScriptFGProjectile)
### Asset Path :
<b><blockquote>/Game/FactoryGame/Character/Creature/Enemy/Spitter/BP_SpitterProjectile.BP_SpitterProjectile_C</blockquote></b>
## Components

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileSphere

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileProjectile

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectilemCollisionComp

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectilemProjectileMovement

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileRootComponent
