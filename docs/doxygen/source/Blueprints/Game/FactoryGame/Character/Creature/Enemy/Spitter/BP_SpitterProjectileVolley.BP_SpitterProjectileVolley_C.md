\page BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileVolley BP_SpitterProjectileVolley
### Parent Class :
[FGProjectile](@ref ClassScriptFGProjectile)
### Asset Path :
<b><blockquote>/Game/FactoryGame/Character/Creature/Enemy/Spitter/BP_SpitterProjectileVolley.BP_SpitterProjectileVolley_C</blockquote></b>
## Components

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileVolleySphere

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileVolleyProjectile

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileVolleymCollisionComp

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileVolleymProjectileMovement

@ref BlueprintsGameFactoryGameCharacterCreatureEnemySpitterBP_SpitterProjectileVolleyRootComponent
