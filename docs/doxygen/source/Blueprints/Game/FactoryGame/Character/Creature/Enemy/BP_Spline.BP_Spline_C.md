\page BlueprintsGameFactoryGameCharacterCreatureEnemyBP_Spline BP_Spline
### Parent Class :
[FGSplinePath](@ref ClassScriptFGSplinePath)
### Asset Path :
<b><blockquote>/Game/FactoryGame/Character/Creature/Enemy/BP_Spline.BP_Spline_C</blockquote></b>
## Components

@ref BlueprintsGameFactoryGameCharacterCreatureEnemyBP_SplinemSpline
