\page BlueprintsGameFactoryGameBuildableBuildingFoundationBuild_PillarMiddle Build_PillarMiddle
### Parent Class :
[FGBuildableFoundation](@ref ClassScriptFGBuildableFoundation)
### Asset Path :
<b><blockquote>/Game/FactoryGame/Buildable/Building/Foundation/Build_PillarMiddle.Build_PillarMiddle_C</blockquote></b>
## Components

@ref BlueprintsGameFactoryGameBuildableBuildingFoundationBuild_PillarMiddleRootComponent
...
### mDisplayName
@htmlonly
<blockquote>INVTEXT("Pillar Middle")</blockquote>
@endhtmlonly

### mDescription
@htmlonly
<blockquote>NSLOCTEXT("", "3D82062D41E119BC12AF33A5527621EE", "Provides a flat floor to build your factory on. \r\nBuildings on top of the foundation are adjusted to a grid, to make it easier to line them up to each other.")</blockquote>
@endhtmlonly
