\page BlueprintsGameFactoryGameBuildableBuildingFoundationBuild_QuarterPipe_02 Build_QuarterPipe_02
### Parent Class :
[FGBuildableFoundation](@ref ClassScriptFGBuildableFoundation)
### Asset Path :
<b><blockquote>/Game/FactoryGame/Buildable/Building/Foundation/Build_QuarterPipe_02.Build_QuarterPipe_02_C</blockquote></b>
## Components

@ref BlueprintsGameFactoryGameBuildableBuildingFoundationBuild_QuarterPipe_02RootComponent
...
### mDisplayName
@htmlonly
<blockquote>INVTEXT("Inverted Quarter Pipe")</blockquote>
@endhtmlonly

### mDescription
@htmlonly
<blockquote>NSLOCTEXT("", "61C125404520A404AC42ABA58B52CC5D", "Provides an optional factory look that is smoother and offers possibilities for recreational activities. \r\nStill utilizes the standard foundation building grid for improved building placement.")</blockquote>
@endhtmlonly
