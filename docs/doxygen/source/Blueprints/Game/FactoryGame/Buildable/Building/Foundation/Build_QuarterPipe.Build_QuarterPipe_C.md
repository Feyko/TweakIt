\page BlueprintsGameFactoryGameBuildableBuildingFoundationBuild_QuarterPipe Build_QuarterPipe
### Parent Class :
[FGBuildableFoundation](@ref ClassScriptFGBuildableFoundation)
### Asset Path :
<b><blockquote>/Game/FactoryGame/Buildable/Building/Foundation/Build_QuarterPipe.Build_QuarterPipe_C</blockquote></b>
## Components

@ref BlueprintsGameFactoryGameBuildableBuildingFoundationBuild_QuarterPipeRootComponent
...
### mDisplayName
@htmlonly
<blockquote>INVTEXT("Quarter Pipe")</blockquote>
@endhtmlonly

### mDescription
@htmlonly
<blockquote>NSLOCTEXT("", "908714D74EC6A116461DBF98BF3DE432", "Provides an optional factory look that is smoother and offers possibilities for recreational activities. \r\nStill utilizes the standard foundation building grid for improved building placement.")</blockquote>
@endhtmlonly
