...
=== What is this "Tweaker"
Tweaker is a mod for Satisfactory. Its goal is to enable any user to tweak their game to their liking. It does so by giving you the ability to change values in the game. It cannot access all of them, but a lot. This is already implemented +
